# From https://github.com/Project-MONAI/tutorials/tree/main/pathology/multiple_instance_learning
...
def parse_args():
    ...
    # 기본으로 세팅 해놓음
    parser.add_argument("--amp", action="store_false", help="use AMP, recommended")
    parser.add_argument(
        "--val_every",
        default=1,
        type=int,
    ...
    # torchrun 사용 하면 지정안해도 되는듯?
    # https://pytorch.org/docs/stable/distributed.elastic.html
    # 일단 single gpu
    parser.add_argument(
        "--dist-url", default="tcp://211.115.110.28:23456", type=str, help="url used to set up distributed training"
    )
