...
parser.add_argument('--aux-loss', default='loss_var', choices=['None', 'loss_dbat', 'loss_div_vc', 'loss_vc', 'loss_div_contrastive', 'loss_var', 'loss_cosine', 'loss_center_vc', 'loss_cosine_vc'], type=str, help='auxiliary loss type')
