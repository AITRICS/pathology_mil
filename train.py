...
parser.add_argument('--aux-loss', default='loss_var', choices=['None', 'loss_dbat', 'loss_var', 'loss_contrastive', 'loss_div_vc', 'loss_div_contrastive'], type=str, help='auxiliary loss type')
parser.add_argument('--num-head', default=1, type=int, help='# of projection head for each instance token')
