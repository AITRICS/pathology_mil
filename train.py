...
parser.add_argument('--aux-loss', default='None', choices=['None', 'loss_dbat', 'loss_var', 'loss_contrastive', 'loss_div_vc', 'loss_div_contrastive'], type=str, help='auxiliary loss type')
...
parser.add_argument('--lr-center', default=0.01, type=float, help='initial learning rate')
...
parser.add_argument('--mil-model', default='Dtfd_add_scale', type=str, help='use pre-training method')
