...
parser.add_argument('--mil-model', default='MonaiMil', choices=['MonaiMil', 'milmax', 'milmean', 'Attention', 'GatedAttention','dsmil','milrnn'], type=str, help='use pre-training method')
